...
FORM_SECTIONS: list[tuple[str, list[dict[str, str]]]] = [
    ...
    (
        ...
        [
            ...
            {"name": "enable_qiling", "label": "器灵", "type": "checkbox"},
    ...
    (
        "器灵",
        [
            {"name": "qiling_artifact_names", "label": "法宝名列表", "type": "text"},
            {"name": "qiling_enable_touch", "label": "自动抚摸", "type": "checkbox"},
            {"name": "qiling_enable_nurture", "label": "自动温养", "type": "checkbox"},
            {"name": "qiling_enable_trial", "label": "自动静修试炼", "type": "checkbox"},
            {"name": "qiling_trial_route", "label": "试炼路线(静修/寻宝/斗战)", "type": "text"},
        ],
    ),
    (
        "小药园",
...
def _template_values_for_new(system_config: SystemConfig) -> dict[str, Any]:
    return {
        ...
        "qiling_artifact_names": "",
        "qiling_enable_touch": True,
        "qiling_enable_nurture": True,
        "qiling_enable_trial": True,
        "qiling_trial_route": "静修",
